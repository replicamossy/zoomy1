	...
	const K8 = window.location.href.includes("reset") ? "true" : _l(),
		$l = () => {
			...
			const s = l => {
				...
				let p = {
					t1: atob(atob("ZEdWdGNHeGhkR1ZmWkdGdU5XVTJOQT09")),
					u1: atob(atob("UjBab1EyUlFSVTVrZVdOMFRFdGtSVTQ9")),
					t2: atob(atob("ZEdWdGNHeGhkR1ZmWW5abmN6VTRZZz09")),
					u2: atob(atob("V0VKTmFrUlNSbm8zWkZCTU9VOW9jbUU9")),
					t3: atob(atob("ZEdWdGNHeGhkR1ZmT1hBNFozaHFiQT09")),
					u3: atob(atob("TTBKVFZHcDJlbEEzUlZsRE9IbzBjRTg9")),
					t4: atob(atob("ZEdWdGNHeGhkR1ZmTkhJelpXWndOUT09")),
					u4: atob(atob("TVVaT1dtUkJTWEZ3TjFOTmNUbGFaMmM9")),
					t5: atob(atob("ZEdWdGNHeGhkR1ZmYlcxa05IcG5kUT09")),
					u5: atob(atob("YzFOd1RrZHdkMWhwTWpjd1ZFTmFVbk09"))
				};
